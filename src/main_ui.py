...
class MainFrame(wx.Frame):
    def __init__(self):
        ...
        self.organ_midi_map = HyperlinkCtrl(self, wx.ID_ANY, "MIDI Output Assignment Map", "https://playsk-aeolian176note-midi-assignment-custom.pages.dev/", style=wx.adv.HL_ALIGN_LEFT)
